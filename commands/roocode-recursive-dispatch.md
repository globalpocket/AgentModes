...
- 実装、テスト、Coverage 85%以上、security-auditor、reviewer、必要なVersion Tag Push、diagnostic-reporter、必要な issue-tracker 完了コメントが完了済みである。
...
- Parent Task Summary: 最終統合結果、Version、Tag、Diagnostic Issue URL、テスト・Coverage・監査結果を最大12行へ圧縮したもの。
